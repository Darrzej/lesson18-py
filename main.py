...
fig = px.bar(size, x='Year', y='Count', color = 'Genre', title="Number of Fiction vs Non=Fiction Books from 2009-2022", color_discrete_sequence=px.colors.sequential.Plasma, barmode='group')
st.plotly_chart(fig)
